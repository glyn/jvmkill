...
#[test]
fn time_0_count_0() {
    assert!(!run_java("org.cloudfoundry.jvmkill.MemoryExhaustion", "=printHeapHistogram=1,heapHistogramMaxEntries=20", &["| [C", "Heap memory:"], &["jvmkill killing current process"]));
}
